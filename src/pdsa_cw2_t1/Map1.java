...
public class Map1 extends javax.swing.JFrame {
    ...
    public static int MapNum,distancecount,c=0,b=0,r=0;
    ...
    private void initComponents() {
        ...
        lblmap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pdsa_cw2_t1/A.png"))); // NOI18N
        ...
        lblmapname.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pdsa_cw2_t1/up (1).png"))); // NOI18N
    ...
    private void btnlaunchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnlaunchActionPerformed
        ...
        int graph[][]=new int[][]{{0,3,6,0},{3,0,2,8},{6,2,0,5},{0,8,5,0}};
        int visited[]=new int[4];
        int min=999,nexnode=0;
        int pred[]=new int[4]; //previous node
