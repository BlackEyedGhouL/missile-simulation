...
public class Map3 extends javax.swing.JFrame {
    ...
    public static int MapNum,distancecount,c=0,b=0,r=0,d=0,e=0;
    ...
    private void initComponents() {
        ...
        lblmap.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pdsa_cw2_t1/A (4).png"))); // NOI18N
        ...
        lblmapname.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pdsa_cw2_t1/up (3).png"))); // NOI18N
        ...
        btnf.setBackground(new java.awt.Color(51, 51, 51));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnf, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbActionPerformed
        ...
        if(d==1)
        {
            distancecount = distancecount+12;
        }
        else
        {
            distancecount = distancecount+10;
        }
    ...
    private void btncActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncActionPerformed
        ...
        {
            distancecount = distancecount+15;
        }
    ...
    private void btnresetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnresetActionPerformed
        ...
        btnf.setBackground(java.awt.Color.darkGray);
        btnb.setEnabled(false);
        btne.setEnabled(false);
        btnf.setEnabled(false);
    ...
    private void btnlaunchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnlaunchActionPerformed
        ...
        int graph[][]=new int[][]{{0,10,15,0,0,0},{10,0,0,12,0,5},{15,0,0,0,10,0},{0,12,0,0,2,5},{0,0,10,2,0,5},{0,5,0,5,5,0}};
        int visited[]=new int[6];
        int min=999,nexnode=0;
        int pred[]=new int[6]; //previous node
    ...
    private void btnfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnfActionPerformed
        ...
        btne.setEnabled(false);
        btnf.setEnabled(false);
        btnf.setBackground(java.awt.Color.gray);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Map3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
